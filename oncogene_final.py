...
def save_accessions_to_sheet(accessions, directory='/Users/swetarai/Downloads', filename="geo_accessions_oncogene.xlsx"):
...
file_path = '/Users/swetarai/Downloads/geo_accessions_oncogene.xlsx'
...
output_file_path = '/Users/swetarai/Downloads/geo_pubmed_metadata_oncogene.xlsx'
metadata_df.to_excel(output_file_path, index=False)
print(f"Data saved to {output_file_path}")

def cleaning(file_path='/Users/swetarai/Downloads/geo_pubmed_metadata_oncogene.xlsx', output_file_path2='/Users/swetarai/Downloads/updated_geo_pubmed_metadata_oncogene.xlsx'):
    df = pd.read_excel(file_path)
...
pubmed_ids = [
    38300710, 38942026, 31331399, 36585452, 30523719, 38167224, 32787886, 34951993,
    32669548, 33817986, 34951993, 38942026, 38167224, 38927507, 34951993, 36976323,
    29452344, 31444334, 34951993, 34951993, 36749874, 33980863
]
results = []
...
output_file_path3 = '/Users/swetarai/Downloads/updated_NCT_WITH_trial_reg_SEARCH_oncogene.xlsx'
